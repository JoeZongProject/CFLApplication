...
/**
 * Created by zongdongdong on 2016/7/29.
 */

public class RichTextUtil {
    public static final String RICHTEXT_STRING = "string";
    public static final String RICHTEXT_COLOR = "color";//表示颜色
    public static final String RICHTEXT_SIZE = "size";//绝对大小px
    public static final String RICHTEXT_RSIZE = "relativesize";//表示相对于控件设置的字体大小的倍数
    public static final String RICHTEXT_DELETE = "delete";//表示删除线
