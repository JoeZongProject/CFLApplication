package com.joecorelibrary.mvvm.widget;
...
{
    /** 默认的清除按钮图标资源 */
    private static final int ICON_CLEAR_DEFAULT = R.mipmap.edittext_clear;

    /** 清楚按钮的图标 */
    private Drawable drawableClear;

    private OnInputChange onInputChange;
...
//         获取清除按钮图标资源
        ...
        addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (onInputChange != null) {
                    onInputChange.onBeforeTextChanged(s, start, count, after);
                }
            }
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (onInputChange != null) {
                    onInputChange.onTextChanged(s, start, before, count);
                }
            }
            ...
            public void afterTextChanged(Editable s) {
                updateIconClear();
                if (onInputChange != null) {
                    onInputChange.onAfterTextChanged(s.toString());
                }
            }
        });
    }
    ...
    public void setOnInputChange(OnInputChange listener){
        this.onInputChange = listener;
    }
