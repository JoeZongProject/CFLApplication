package com.joecorelibrary.mvvm.widget.banner;
...
import com.joecorelibrary.R;
import com.joecorelibrary.mvvm.widget.banner.transformer.BGAPageTransformer;
import com.joecorelibrary.mvvm.widget.banner.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private int mPointDrawableResId = R.drawable.bga_banner_selector_point_hollow_white;
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mPointContainerBackgroundDrawable = new ColorDrawable(Color.parseColor("#ffffff"));
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.BGABanner_banner_pointDrawable) {
            mPointDrawableResId = typedArray.getResourceId(attr, R.drawable.bga_banner_selector_point_hollow_white);
        ...
        } else if (attr == R.styleable.BGABanner_banner_isNeedShowIndicator) {
            mIsNeedShowIndicator = typedArray.getBoolean(attr, mIsNeedShowIndicator);
        }
    }

    private void initView(Context context) {
        if (!mIsNeedShowIndicator) {
            return;
        }
...
//            mViews.add(imageView);
    ...
    public int getPlaceHolderImage() {
        return mPlaceholderDrawableResId;
    }
