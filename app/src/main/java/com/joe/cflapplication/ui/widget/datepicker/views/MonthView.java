package com.joe.cflapplication.ui.widget.datepicker.views;
...
import com.joe.cflapplication.ui.widget.datepicker.bizs.calendars.DPCManager;
import com.joe.cflapplication.ui.widget.datepicker.bizs.decors.DPDecor;
...
import com.joe.cflapplication.ui.widget.datepicker.entities.DPInfo;
            ...
            for (int j = 0; j < tmp[i].length; j++) {
                ...
                if (region.contains(x, y)) {
                    ...
                    if (mDPMode == DPMode.SINGLE) {
                        cirApr.clear();
                        regions.add(region);
                        final String date = centerYear + "年" + strFormat2(centerMonth + "") + "月" +
                                strFormat2(mCManager.obtainDPInfo(centerYear, centerMonth)[i][j].strG + "") + "日";
